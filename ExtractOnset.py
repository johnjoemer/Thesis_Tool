...
output_folder = r"C:\Users\Obey\OneDrive - Polytechnic University of the Philippines\Desktop\Thesis Tool\Dataset 6\Extracted_OnsetFrames"
...
for index, row in df.iterrows():
    ...
    source_path = os.path.join(source_root_folder, f'sub{subject}', filename, f'reg_img{onset_frame}.jpg')
    output_path = os.path.join(output_folder, f'{filename}_frame{onset_frame}.jpg')
    ...
    if os.path.exists(source_path):
        ...
        for file_name in os.listdir(os.path.dirname(source_path)):
            if file_name == f'reg_img{onset_frame}.jpg':
